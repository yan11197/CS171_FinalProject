...
ScatterOverTime.prototype.initVis = function() {
    ...
    vis.margin = { top: 0, right: 0, bottom: 35, left: 60};
    ...
    vis.svg.append("text")
        ...
        .attr("transform",
            ...
            (vis.height + vis.margin.bottom - 5) + ")")
        .style("text-anchor", "middle")
        .style("font-size", 12);
...
ScatterOverTime.prototype.updateVis = function() {
    ...
    function tool_tip_player_details(d, x_y) {
        ...
        for (var i = 0; i < qb_tip_stats.length; i++) {
            vis.svg.append("text")
                ...
                .attr("x", x_y[0])
                .attr("y", x_y[1] - (qb_tip_stats.length - i) * 18)
                .attr("font-size", 12)
    ...
    // .on('mouseover', tool_tip_player_details.show)
